...
metadata:
  argument-hint: "[init | update | review | explain | pass]"
---
...
The user invoked `/turtleneck <mode>`. The mode argument is in `$1` (it may
...
- **Only an explicit, unambiguous `$1` of `pass` or `update` may enter a
